...
@section('content')
    ...
    @if(session('link_gerado'))
        <div class="bg-slate-800 p-8 rounded-xl shadow-2xl border border-green-500/30 text-center animate-fade-in">
            ...
            <p class="text-slate-400 mb-6">Este link dá acesso direto ao segredo.</p>
            ...
            <div class="p-6 md:p-8">
                <form action="{{ route('secret.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6 relative">
                        <label class="block text-xs font-bold text-slate-400 uppercase mb-1 ml-1">Seu Nome / Identificação
                            (Opcional)</label>
                        <div class="relative">
                            ...
                            <input type="text" name="sender"
                                ...
                                placeholder="Ex: João da TI">
                        </div>
                    </div>

                    <div id="area-text">
                        <div class="mb-1">
                            <label class="block text-sm font-medium text-slate-300 mb-2">Digite a senha ou texto que vai
                                compartilhar</label>
                        ...
                        <div class="mb-8 border border-slate-600 rounded-lg p-4 bg-slate-900/30">
                            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                                <div class="text-center md:text-left">
                                    <h3 class="text-sm font-bold text-slate-200">Precisa de ajuda para gerar uma senha segura?
                                    </h3>
                                </div>
                                <div class="flex gap-2 shrink-0">
                                    <button type="button" onclick="generatePass(true)"
                                        class="bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold py-2 px-4 rounded transition">Gerar
                                        senha</button>
                                    <button type="button" onclick="toggleOptions()"
                                        class="bg-slate-700 hover:bg-slate-600 text-slate-200 text-xs font-bold py-2 px-4 rounded transition border border-slate-600">Opções</button>
                                </div>
                            </div>
                    ...
                    <div id="area-file" class="hidden mb-8">
                        ...
                        <div
                            ...
                            <div class="pointer-events-none relative z-0">
                                ...
                                <p id="fileNameDisplay" class="text-slate-400 text-sm font-medium">Clique ou arraste um arquivo
                                    aqui</p>
                        ...
                        <div class="mb-1">
                            <label class="block text-sm font-medium text-slate-300 mb-2">2. Adicionar nota ou senha
                                (Opcional)</label>
